  ...
  <nav class="navbar navbar-expand-md bg-dark navbar-dark">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="checkout.php"><i class="fas fa-money-check-alt mr-2"></i>Thanh Toán</a>
        </li>
        <li class="nav-item">
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-6 px-4 pb-4" id="order">
        <h4 class="text-center text-info p-2">Hoàn tất mua hàng</h4>
        <div class="jumbotron p-3 mb-2 text-center">
          <h6 class="lead"><b>Sản Phẩm : </b><?= $allItems; ?></h6>
          <h6 class="lead"><b>Phí Giao hàng : </b>Free</h6>
